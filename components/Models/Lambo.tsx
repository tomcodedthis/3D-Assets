...
export default function Lambo(props: any) {
  const { nodes, materials } = useGLTF(
    "../model-scenes/lambo/scene.gltf"
  ) as unknown as GLTFResult;
  return (
    <group {...props} dispose={null}>
      <group
        rotation={props.defaultPosition[0].rotation}
        position={props.defaultPosition[0].position}
        scale={props.defaultPosition[0].scale}
      >
        <mesh
          castShadow
          receiveShadow
...
useGLTF.preload("../model-scenes/lambo/scene.gltf");
