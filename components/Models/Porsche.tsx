...
export default function Porsche(props: any) {
  const { nodes, materials } = useGLTF(
    "../model-scenes/porsche/scene.gltf"
  ...
  return (
    <group {...props} dispose={null}>
      <group
        ...
        // scale={1.3}
        rotation={props.defaultPosition[1].rotation}
        position={props.defaultPosition[1].position}
        scale={props.defaultPosition[1].scale}
      >
        <mesh
          castShadow
          receiveShadow
...
useGLTF.preload("../model-scenes/porsche/scene.gltf");
